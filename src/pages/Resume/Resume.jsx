...
import { forward, backward, setProfile, setWork, addEducation, removeEducation } from "./ResumeSlice";
...
export function Resume() {
  ...
  switch (step) {
    case 1:
      return (
        <ResumeContainer>
          <ProfileSection values={values.profile} handleChange={handleChange} />
          <ButtonContainer>
    ...
    case 2:
      return (
        <ResumeContainer>
          ...
          />
          <EducationButtonContainer>
            <button onClick={()=> {dispatch(addEducation())}}>Add Education</button>
            <button onClick={()=> {dispatch(removeEducation())}}>Remove Education</button>
          </EducationButtonContainer>
          <ButtonContainer>
